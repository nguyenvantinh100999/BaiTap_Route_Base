...
const UpdateProduct = () => {
  ...
  const getProductId = async () => {
    ...
    // prodEditForm.setFieldValue("name", res.data.name); set value tùy biến
  ...
  const prodEditForm = useFormik({
    ...
    onSubmit: async (value) => {
      ...
      const res = await axios.put(
        `https://apitraining.cybersoft.edu.vn/api/ProductApi/update/${value.id}`,
        value
      );
            ...
            <div className="card-body">
              <form onSubmit={prodEditForm.handleSubmit}>
                <div className="mb-3">
                  ...
                  <input
                    value={prodEditForm.values.id}
                    onChange={prodEditForm.handleChange}
                    type="text"
                ...
                <div className="mb-3">
                  ...
                  <input
                    value={prodEditForm.values.name}
                    onChange={prodEditForm.handleChange}
                    type="text"
                    className="form-control"
                    name="name"
                ...
                <div className="mb-3">
                  ...
                  <input
                    value={prodEditForm.values.price}
                    onChange={prodEditForm.handleChange}
                    type="text"
                    className="form-control"
                    name="price"
                ...
                <div className="mb-3">
                  ...
                  <input
                    value={prodEditForm.values.description}
                    onChange={prodEditForm.handleChange}
                    type="text"
                    className="form-control"
                    name="description"
                ...
                <div className="mb-3">
                  ...
                  <select
                    value={prodEditForm.values.type}
                    onChange={prodEditForm.handleChange}
                    className="form-control"
                    name="type"
                  >
